  ...
  return (
    <div className='h-full flex flex-col justify-between '>
      ...
      <div className='md:flex md:flex-col justify-between h-fit w-full'>
        ...
        <div className='flex'>
          <a className='ml-20 mt-3 py-2 px-2 text-sm font-medium border border-gray-500 hover:border-gray-300 hover:text-gray-200 text-center text-white rounded-lg transition duration-300 ease-in-out sm:w-fit' href="https://drive.google.com/file/d/1X3V8SO1b98RVVgxrcqOH7YBx4f9MmZA1/view?usp=sharing" target="blank"> CV</a>
